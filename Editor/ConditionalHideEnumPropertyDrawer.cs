...
public class ConditionalEnumHidePropertyDrawer : PropertyDrawer
{
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        GUI.enabled = (/*(condHAtt.EnumValue1 == enumValue) || (condHAtt.EnumValue2 == enumValue) || */(condHAtt.EnumValues.Contains(enumValue) && enumValue > 0));
        if (!condHAtt.HideInInspector || /*(condHAtt.EnumValue1 == enumValue) || (condHAtt.EnumValue2 == enumValue) ||*/ (condHAtt.EnumValues.Contains(enumValue) && enumValue > 0))
        {
